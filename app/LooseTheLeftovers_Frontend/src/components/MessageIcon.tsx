 ...
 * Will take you to the messaging screen
 *
 * @component
...
const MessageIcon: React.FC<AllIconProps> = ({ size = 45 }) => {
  ...
  const goToHomeScreen = () => {
    navigation.navigate('Instruction', { name: 'MessageIcon' });
  };
  ...
  return (
    <TouchableOpacity onPress={goToHomeScreen} testID={'MessageIconTest'}>
      <Image
